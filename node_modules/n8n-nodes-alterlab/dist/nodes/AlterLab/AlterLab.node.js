                    ...
                    options: [
                        {
                            ...
                            type: 'boolean',
                            default: false,
                            description: 'Whether to render JavaScript with a headless browser (+3 credits)',
                        },
                        {
                            ...
                            type: 'boolean',
                            default: false,
                            description: 'Whether to capture a full-page screenshot (+1 credit, requires Render JavaScript)',
                            displayOptions: {
                                show: {
                                    renderJs: [true],
                                },
                        ...
                        },
                        {
                            ...
                            type: 'boolean',
                            default: false,
                            description: 'Whether to generate a PDF of the rendered page (+2 credits, requires Render JavaScript)',
                            displayOptions: {
                                show: {
                                    renderJs: [true],
                                },
                        ...
                        },
                        {
                            ...
                            type: 'boolean',
                            default: false,
                            description: 'Whether to extract text from images using OCR (+5 credits, refunded if no images found)',
                        },
                        {
                            ...
                            type: 'boolean',
                            default: false,
                            description: 'Whether to route through a premium proxy (+1 credit)',
                        },
                        {
                    ...
                    options: [
                        {
                            ...
                            description: 'Maximum credits to spend (0 = no limit)',
                        },
                        {
    ...
    async execute() {
        ...
        for (let i = 0; i < items.length; i++) {
            try {
                ...
                output.billing = {
                    credits: (_x = (_w = billing === null || billing === void 0 ? void 0 : billing.total_credits) !== null && _w !== void 0 ? _w : data.credits_used) !== null && _x !== void 0 ? _x : 0,
    ...
    switch (statusCode) {
        ...
        case 402:
            throw new n8n_workflow_1.NodeApiError(ctx.getNode(), body, {
                ...
                description: `${detail}. Top up your credits at https://app.alterlab.io/dashboard/billing?${UTM}`,
                httpCode: '402',
                itemIndex,
            });
        case 429:
